...
class CategoryExpense(BaseModel):
    ...
    model_config = ConfigDict(
        json_schema_extra={"example": {"category": "Groceries", "total": 450.00}}
    )
...
class MonthlySummaryResponse(BaseModel):
    ...
    total_income: Decimal = Field(
        ..., serialization_alias="totalIncome", description="Total income for the month"
    )
    ...
    net_balance: Decimal = Field(
        ..., serialization_alias="net", description="Net balance (income - expenses)"
    )
